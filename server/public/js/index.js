...
/***/ (function(module, exports, __webpack_require__) {
	...
	var syy = new _lottery2.default(); //兼容库//import './class/less8.js'
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _timer = __webpack_require__(300);

	var _timer2 = _interopRequireDefault(_timer);

	var _calculate = __webpack_require__(301);

	var _calculate2 = _interopRequireDefault(_calculate);

	var _base = __webpack_require__(302);
	...
	var Lottery = function (_mix) {
	    ...
	    _createClass(Lottery, [{
	        ...
	        value: function initEvent() {
	            ...
	            (0, _jquery2.default)('.boll-list').on('click', '.btn-boll', self.toogleCodeActive.bind(self));
	            ...
	            (0, _jquery2.default)('qkmethond').on('click', '.btn-middle', self.getRandomCode.bind(self));
	        }
	    }]);

	    return Lottery;
	}(mix(_timer2.default, _base2.default, _interface2.default, _calculate2.default));
	...
	var Timer = function () {
	    ...
	    _createClass(Timer, [{
	        ...
	        value: function countdown(end, update, handle) {
	            //end截止时间 update时间更新回调  handle结束后的回调
	            ...
	            if (now - end > 0) {
	                ...
	                var m = Math.floor((last_time - d * px_d - h) / px_m);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Base = function () {
	    ...
	    _createClass(Base, [{
	        ...
	        key: 'toogleCodeActive',
	        value: function toogleCodeActive(e) {
	            var self = this;
	            var $cur = (0, _jquery2.default)(e.currentTarget); //选中当前DOM
	        ...
	        value: function changePlayNav(e) {
	            ...
	            (0, _jquery2.default)('#zx_xm span').html(self.play_list.get(self.cur_play).tip);
	        ...
	        value: function assistHandle(e) {
	            ...
	            var self = this;
	            var $cur = (0, _jquery2.default)(e.currentTarget);
	            var index = $cur.index(); //.index()  获得其相对于同胞元素的 index 位置
	            (0, _jquery2.default)('.boll-list .btn-boll').removeClass('btn-boll-active');
	            if (index === 0) {
